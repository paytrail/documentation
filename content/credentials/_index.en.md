...
{{< notice note >}}Paytrail sets a minimum limit of **0,65 €** for test payment amount. Payments with amount below will give `System error - unknown error` message on payment page.{{< /notice >}}
